...
const Banner = () => {
  return (
    <div className="banner relative bg-cover bg-center bg-no-repeat xl:h-[80vh] lg:h-[90vh] h-[70vh] overflow-hidden">
      ...
      <Image
        className="absolute max-w-[350px] min-h-[200px] lg:block hidden 2xl:bottom-10 -bottom-4 rotate-[340deg] right-[20%] border-8 border-white"
        src={bannerside2}
        width={300}
        height={300}
        alt="bannerside1"
      />
      <Image
        className="absolute max-w-[300px] lg:block hidden top-0 rotate-[6deg] 2xl:right-[10%] right-[8%] border-8 border-white"
        src={bannerside1}
        width={300}
        height={300}
        alt="bannerside1"
